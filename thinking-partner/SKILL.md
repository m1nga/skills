...
description: Automatic thinking-partner mode for ambiguous framing, open exploration, trade-off analysis, or decisions where misreading the need would materially change direction. Trigger semantically when the primary deliverable is better understanding, option-building, or judgment — no magic words required. Natural triggers include "help me think this through", "I'm torn between X and Y", "am I even asking the right question", "am I framing this right", "what am I missing", and Chinese phrasing such as 帮我想想 / 你帮我想想 / 我在纠结. Do not use as a global wrapper for fact research, execution or building, artifact review or diagnosis, summarization, extraction, translation, monitoring, or status work with a clear target. For interrogating an explicit build plan step-by-step, defer to grilling. For mixed requests, apply only to the unresolved decision fork, then continue with the relevant research, execution, or review workflow in the same task. Never ask the user to decide whether this skill should be invoked.
---
